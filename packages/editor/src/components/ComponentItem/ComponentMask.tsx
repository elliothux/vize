...
export function ComponentMask({ instance, selected, onClick, onContextMenu }: Props) {
    const {
        info: { name },
    } = useMemo<MaterialsComponentMeta>(() => materialsStore.getComponentMeta(instance.component), [
        instance.component,
    ]);
